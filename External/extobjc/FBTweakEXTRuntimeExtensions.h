 ...
 */
typedef void (*FBTweakEXT_failedMethodCallback)(Class, Method);

/**
 * Used with #FBTweakEXT_injectMethods to determine injection behavior.
 */
typedef NS_OPTIONS(NSUInteger, FBTweakEXT_methodInjectionBehavior) {
    /**
     * Indicates that any existing methods on the destination class should be
     * overwritten.
     */
    FBTweakEXT_methodInjectionReplace                  = 0x00,

    /**
     * Avoid overwriting methods on the immediate destination class.
     */
    FBTweakEXT_methodInjectionFailOnExisting           = 0x01,
    
    /**
     * Avoid overriding methods implemented in any superclass of the destination
     * class.
     */
    FBTweakEXT_methodInjectionFailOnSuperclassExisting = 0x02,

    /**
     * Avoid overwriting methods implemented in the immediate destination class
     * or any superclass. This is equivalent to
     * <tt>FBTweakEXT_methodInjectionFailOnExisting | FBTweakEXT_methodInjectionFailOnSuperclassExisting</tt>.
     */
    FBTweakEXT_methodInjectionFailOnAnyExisting        = 0x03,

    /**
     * Ignore the \c +load class method. This does not affect instance method
     * injection.
     */
    FBTweakEXT_methodInjectionIgnoreLoad = 1U << 2,

    /**
     * Ignore the \c +initialize class method. This does not affect instance method
     * injection.
     */
    FBTweakEXT_methodInjectionIgnoreInitialize = 1U << 3
};

/**
 * A mask for the overwriting behavior flags of #FBTweakEXT_methodInjectionBehavior.
 */
static const FBTweakEXT_methodInjectionBehavior FBTweakEXT_methodInjectionOverwriteBehaviorMask = 0x3;
...
typedef enum {
     ...
     */
    FBTweakEXT_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    FBTweakEXT_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    FBTweakEXT_propertyMemoryManagementPolicyCopy
} FBTweakEXT_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #FBTweakEXT_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    FBTweakEXT_propertyMemoryManagementPolicy memoryManagementPolicy;
 ...
 */
Class *FBTweakEXT_copySubclassList (Class aClass, unsigned *subclassCount);
 ...
 */
#define FBTweakEXT_getIvar(OBJ, IVAR, TYPE) \
 ...
 * or floating-point types.
 */
#define FBTweakEXT_getIvarByName(OBJ, NAME, TYPE) \
    FBTweakEXT_getIvar((OBJ), class_getInstanceVariable(object_getClass((OBJ)), (NAME)), TYPE)
 ...
 */
unsigned FBTweakEXT_injectMethods (Class aClass, Method *methods, unsigned count, FBTweakEXT_methodInjectionBehavior behavior, FBTweakEXT_failedMethodCallback failedToAddCallback);

/**
 * Invokes #FBTweakEXT_injectMethods with the instance methods and class methods from
 * \a srcClass. #FBTweakEXT_methodInjectionIgnoreLoad is added to #behavior for class
 * method injection.
 *
 * Returns whether all methods were added successfully. For each method that fails
 * to be added, \a failedToAddCallback (if provided) is invoked.
 ...
 */
BOOL FBTweakEXT_injectMethodsFromClass (Class srcClass, Class dstClass, FBTweakEXT_methodInjectionBehavior behavior, FBTweakEXT_failedMethodCallback failedToAddCallback);
 ...
 *
 * @li Each protocol is loaded with #FBTweakEXT_loadSpecialProtocol and a custom block
 ...
 * #FBTweakEXT_specialProtocolReadyForInjection.
 ...
 * #FBTweakEXT_specialProtocolReadyForInjection as well.
 *
 ...
 *
 * @sa FBTweakEXT_loadSpecialProtocol
 */
