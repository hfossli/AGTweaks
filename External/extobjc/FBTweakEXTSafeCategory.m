...
#import "FBTweakEXTSafeCategory.h"
...
BOOL FBTweakEXT_loadSafeCategory (Class methodContainer, Class targetClass) {
    ...
    return FBTweakEXT_injectMethodsFromClass(
        methodContainer,
        targetClass,
        FBTweakEXT_methodInjectionFailOnAnyExisting | FBTweakEXT_methodInjectionIgnoreLoad,
