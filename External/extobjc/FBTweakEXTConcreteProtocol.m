...
#import "FBTweakEXTConcreteProtocol.h"
#import "FBTweakEXTRuntimeExtensions.h"
#import <pthread.h>
#import <stdlib.h>

static void FBTweakEXT_injectConcreteProtocol (Protocol *protocol, Class containerClass, Class class) {
...
BOOL FBTweakEXT_addConcreteProtocol (Protocol *protocol, Class containerClass) {
    return FBTweakEXT_loadSpecialProtocol(protocol, ^(Class destinationClass){
        FBTweakEXT_injectConcreteProtocol(protocol, containerClass, destinationClass);
    });
}

void FBTweakEXT_loadConcreteProtocol (Protocol *protocol) {
    FBTweakEXT_specialProtocolReadyForInjection(protocol);
}
